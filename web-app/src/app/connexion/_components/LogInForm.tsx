    ...
    <>
      <form className="w-full space-y-6" onSubmit={handleSubmit(onSubmit)}>
        <div className="mb-2">
          ...
          <input className="block w-full border-b-2 px-2.5 py-2.5 bg-sp-primary-50 transition-colors border-b-sp-primary-400 hover:border-b-sp-primary-300 focus:border-b-sp-primary-300 shadow-sm outline-none" {...register('email')} />
          {errors.email && <span className="">This field is required</span>}
        </div>

        <div className="mb-2">
          <div className="flex items-center justify-between">
            <label className="block text-sm lg:text-base font-medium leading-6 text-gray-500">Mot de passe</label>
            <div className="">
              <a href="#" className="font-semibold text-sm lg:text-base text-sp-primary-400 hover:text-sp-primary-300 transition-colors ">Mot de passe oublié ?</a>
            </div>
          </div>
          <input
